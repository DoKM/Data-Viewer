...
var MongooseDB = /** @class */ (function () {
    ...
    MongooseDB.prototype.connect = function (urlPart) {
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                ...
                                var connectHandler = function (url, tryAmount) {
                                    _this.mongoose.connect(url, function (err) {
                                        if (err) {
                                            tryAmount++;
                                            console.error('Failed to connect to mongo on startup - retrying in 5 sec', err);
                                            if (tryAmount > 8) {
                                                var error = new mongoose_2.Error("Connection failed more than 10 times");
                                                reject(error);
                                            }
